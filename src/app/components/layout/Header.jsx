...
function Header() {
  return (
    <header className="relative z-50">
      <div className="flex items-center justify-between px-14 py-[14px] border-b border-oxv-border-divider">
        <Link href="/">
          <Image src={logo} alt="OXVLO" height={26} width={Math.round((logo.width / logo.height) * 26)} />
        </Link>
